...
//import com.revature.controllers.ItemControler
...
public class Driver {
	public static void main(String[] args) {
		...
		app.post("/users/:username/cart", uc::getCart);
		
		// As a player, I can level up my gacha
		//app.put("/users/:username/inventory/:itemID", uc::itemID);
		
		// As a player, I can view my gachas
		app.get("/users/:username/inventory", uc::viewCart);
		
		//As an admin, I van add an Gacha object
		//app.post("/users/:username/", ItemController::addItem);
	}
}
